...
const renderRules = {
  ...
  // The main container
  body: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_body
  }, children),
  // Headings
  heading1: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_heading1
  }, children),
  heading2: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_heading2
  }, children),
  heading3: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_heading3
  }, children),
  heading4: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_heading4
  }, children),
  heading5: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_heading5
  }, children),
  heading6: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_heading6
  }, children),
  // Horizontal Rule
  hr: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_hr
  }),
  // Emphasis
  strong: (node, children, parent, styles) => /*#__PURE__*/React.createElement(Text, {
    key: node.key,
    style: styles.strong
  }, children),
  em: (node, children, parent, styles) => /*#__PURE__*/React.createElement(Text, {
    key: node.key,
    style: styles.em
  }, children),
  s: (node, children, parent, styles) => /*#__PURE__*/React.createElement(Text, {
    key: node.key,
    style: styles.s
  }, children),
  // Blockquotes
  blockquote: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_blockquote
  }, children),
  // Lists
  bullet_list: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_bullet_list
  }, children),
  ordered_list: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
  ...
  list_item: (node, children, parent, styles, inheritedStyles = {}) => {
    ...
    if (hasParents(parent, 'ordered_list')) {
      ...
      }, listItemNumber, node.markup), /*#__PURE__*/React.createElement(View, {
  ...
  // Code
  code_inline: (node, children, parent, styles, inheritedStyles = {}) => /*#__PURE__*/React.createElement(Text, {
    key: node.key,
  ...
  // Tables
  table: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_table
  }, children),
  thead: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_thead
  }, children),
  tbody: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_tbody
  }, children),
  th: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_th
  }, children),
  tr: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_tr
  }, children),
  td: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_td
  }, children),
  // Links
  link: (node, children, parent, styles, onLinkPress) => /*#__PURE__*/React.createElement(View, {
    key: node.key
  }, /*#__PURE__*/React.createElement(Text, {
    key: node.key,
    style: styles.link,
  ...
  blocklink: (node, children, parent, styles, onLinkPress) => /*#__PURE__*/React.createElement(TouchableWithoutFeedback, {
    key: node.key,
    onPress: () => openUrl(node.attributes.href, onLinkPress),
  ...
  image: (node, children, parent, styles, allowedImageHandlers, defaultImageHandler) => {
    ...
    return /*#__PURE__*/React.createElement(FitImage, imageProps);
  },
  // Text Output
  ...
  textgroup: (node, children, parent, styles) => /*#__PURE__*/React.createElement(Text, {
    key: node.key,
    style: styles.textgroup
  }, children),
  paragraph: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_paragraph
  }, children),
  hardbreak: (node, children, parent, styles) => /*#__PURE__*/React.createElement(Text, {
    key: node.key,
    style: styles.hardbreak
  }, '\n'),
  softbreak: (node, children, parent, styles) => /*#__PURE__*/React.createElement(Text, {
    key: node.key,
    style: styles.softbreak
  }, '\n'),
  // Believe these are never used but retained for completeness
  pre: (node, children, parent, styles) => /*#__PURE__*/React.createElement(View, {
    key: node.key,
    style: styles._VIEW_SAFE_pre
  }, children),
  inline: (node, children, parent, styles) => /*#__PURE__*/React.createElement(Text, {
    key: node.key,
    style: styles.inline
  }, children),
  span: (node, children, parent, styles) => /*#__PURE__*/React.createElement(Text, {
    key: node.key,
    style: styles.span
  }, children)
};
